box::use(
  #app/logic/analyte_data/AnalyteDataManager[FeatureAnalysisAnalyteDataManager],
  app/logic/app_resources/data_services[ODBCQueryManager],
  app/logic/shared/string_utils[parse_delimited_string],
  #app/logic/analyte_data/analyte_plot_helpers[getDensityColors],
  app/logic/shared/analyte_plots[getScatterPlotWithSmoothing]
)
