...
precalc_feature_analysis_server <- function(id, r6, ...) {
  ...
  moduleServer(id, function(input, output, session) {
    ...
    gargoyle::init("get_volcano_data", "show_analyte_plot", "sync_analyte_choice", "disable_GSEA", "enable_GSEA", "run_GSEA", "add_GSEA_trace_to_volcano",  session = session)

    TrisomExploreR::precalc_feature_analysis_inputs_server(id = "Inputs", r6 = r6, ...)
